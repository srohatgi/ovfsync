...
public class BlankVMs {
	...
	//String imageDir = "C:/development/workspaces/VCD-SDK-5.1.0/src/main/resources";
...
/*
		String ovfFileLocation =  imageDir + "/" + nameOvfRhel;
		...
		*/
		...
		vappTemplate.uploadOVFFile(descriptorInputStream, descriptorInputStream.available());
		...
		/*String vmdkFileLocation =  imageDir + "/" + vmdkfileName;
